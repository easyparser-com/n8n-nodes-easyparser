	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			// ─── BULK SUBMIT fields ──────────────────────────────────────────────
			{
				...
				default: 'DETAIL',
				required: true,
				description: 'The type of operation to perform in bulk',
				displayOptions: {
					show: {
			...
			// ─── BULK GET RESULT fields ──────────────────────────────────────────────
			{
				...
				description: 'The unique query ID returned from a Bulk Submit response (results[].id)',
				displayOptions: {
					show: {
